...
int
acm_cv_create (converter_fmt_t *cfmt, u_char *state, u_int32 *state_len)
{
        LPHACMSTREAM lpa;
        ...
        acm_conv_init_fmt(&wfxSrc, cfmt->from_channels, cfmt->from_freq);
        acm_conv_init_fmt(&wfxDst, cfmt->to_channels,   cfmt->to_freq);
