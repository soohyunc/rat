...
void ui_info_update_name  (struct s_session *s, struct s_rtcp_dbentry *e);
void ui_info_update_cname (struct s_session *s, struct s_rtcp_dbentry *e);
void ui_info_update_email (struct s_session *s, struct s_rtcp_dbentry *e);
void ui_info_update_phone (struct s_session *s, struct s_rtcp_dbentry *e);
void ui_info_update_loc   (struct s_session *s, struct s_rtcp_dbentry *e);
void ui_info_update_tool  (struct s_session *s, struct s_rtcp_dbentry *e);
void ui_info_update_note  (struct s_session *s, struct s_rtcp_dbentry *e);
void ui_info_mute         (struct s_session *s, pdb_entry_t           *pdbe);
void ui_info_gain         (struct s_session *s, pdb_entry_t           *pdbe);
void ui_info_remove       (struct s_session *s, struct s_rtcp_dbentry *e);
void ui_info_activate     (struct s_session *s, struct s_rtcp_dbentry *e);
void ui_info_deactivate   (struct s_session *s, struct s_rtcp_dbentry *e);
void ui_info_3d_settings  (struct s_session *s, struct s_rtcp_dbentry *e, pdb_entry_t *p);
...
void ui_update_stats         (struct s_session *s, pdb_entry_t *pdbe);

void ui_update_lecture_mode  (struct s_session *session_pointer);
void ui_update               (struct s_session *session_pointer);
void ui_update_loss          (struct s_session *sp, u_int32 srce, u_int32 dest, int loss);
void ui_update_reception     (struct s_session *s, u_int32 ssrc, u_int32 recv, u_int32 lost, 
                              u_int32 misordered, u_int32 duplicates, u_int32 jitter, int jit_tog);
void ui_update_duration      (struct s_session *s, u_int32 ssrc, int duration);
void ui_update_video_playout (struct s_session *s, u_int32 ssrc, int playout);
