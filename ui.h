...
void ui_info_update_name  (struct s_session *s, u_int32_t ssrc);
void ui_info_update_cname (struct s_session *s, u_int32_t ssrc);
void ui_info_update_email (struct s_session *s, u_int32_t ssrc);
void ui_info_update_phone (struct s_session *s, u_int32_t ssrc);
void ui_info_update_loc   (struct s_session *s, u_int32_t ssrc);
void ui_info_update_tool  (struct s_session *s, u_int32_t ssrc);
void ui_info_update_note  (struct s_session *s, u_int32_t ssrc);
void ui_info_mute         (struct s_session *s, u_int32_t ssrc);
void ui_info_gain         (struct s_session *s, u_int32_t ssrc);
void ui_info_remove       (struct s_session *s, u_int32_t ssrc);
void ui_info_activate     (struct s_session *s, u_int32_t ssrc);
void ui_info_deactivate   (struct s_session *s, u_int32_t ssrc);
void ui_info_3d_settings  (struct s_session *s, u_int32_t ssrc);
...
void ui_update_stats         (struct s_session *s, u_int32_t ssrc);

void ui_update_lecture_mode  (struct s_session *session_pointer);
void ui_update               (struct s_session *session_pointer);
void ui_update_loss          (struct s_session *sp, u_int32_t srce, u_int32_t dest, int loss);
void ui_update_reception     (struct s_session *s, u_int32_t ssrc, u_int32_t recv, u_int32_t lost, 
                              u_int32_t misordered, u_int32_t duplicates, u_int32_t jitter, int jit_tog);
void ui_update_duration      (struct s_session *s, u_int32_t ssrc, int duration);
void ui_update_video_playout (struct s_session *s, u_int32_t ssrc, int playout);
