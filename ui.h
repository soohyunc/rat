...
void ui_info_update_name  (struct s_session *s, u_int32 ssrc);
void ui_info_update_cname (struct s_session *s, u_int32 ssrc);
void ui_info_update_email (struct s_session *s, u_int32 ssrc);
void ui_info_update_phone (struct s_session *s, u_int32 ssrc);
void ui_info_update_loc   (struct s_session *s, u_int32 ssrc);
void ui_info_update_tool  (struct s_session *s, u_int32 ssrc);
void ui_info_update_note  (struct s_session *s, u_int32 ssrc);
void ui_info_mute         (struct s_session *s, pdb_entry_t           *pdbe);
void ui_info_gain         (struct s_session *s, pdb_entry_t           *pdbe);
void ui_info_remove       (struct s_session *s, u_int32 ssrc);
void ui_info_activate     (struct s_session *s, u_int32 ssrc);
